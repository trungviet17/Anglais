...
urlpatterns = [
    ...
    path('flashcard/delete-word/<int:form_id>/<int:word_id>', views.delete_word, name = 'delete_word'), 
    ...
    path('flashcard/edit-word/<int:form_id>/<int:word_id>', views.edit_word, name="edit_word"), 
